...
/**
 * The Zerops path (sign in, then straight into a solely-connected project or
 * a picker) is additive over the old manual-connect flow — see
 * `ZeropsHostedLanding` and its `ManualConnectFallback`, which keeps that
 * flow reachable for anyone without a Zerops account.
 */
